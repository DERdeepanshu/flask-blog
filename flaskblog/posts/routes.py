from flask import (	request, render_template,
					url_for, flash, redirect, Blueprint, abort)
...
def update_post(post_id):
	...
	return render_template('create_post.html', title="Update Post", form=form, legend="Update Post", current_user=current_user)
