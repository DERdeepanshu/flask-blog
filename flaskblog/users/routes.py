...
def account(user_id):
	...
	if current_user.id == user.id:
		...
		return render_template('accounts.html', title='Account', image_file=image_file, form=form, current_user=current_user, user=current_user, posts=posts)
	else:
		image_file = url_for('static', filename='profile_pics/'+ user.image_file)
		return render_template('another_account.html', title=user.username, image_file=image_file, current_user=current_user, user=user, posts=posts)
